...
public enum JavaVersion {
  ...
  /**
   * Java 18 major version. Not officially supported by Gradle. Use at your own risk.
   *
   * @since 7.0
   */
  @Incubating
  ...
  /**
   * Java 19 major version. Not officially supported by Gradle. Use at your own risk.
   *
   * @since 7.0
   */
  @Incubating
  ...
  JavaVersion() {
    this.versionName =
        ordinal() >= FIRST_MAJOR_VERSION_ORDINAL ? getMajorVersion() : "1." + getMajorVersion();
  }
  ...
  public static JavaVersion current() {
    if (currentJavaVersion == null) {
      // deenu modfify: return java version 1.8
