...
public class DaemonParameters {
  ...
  public static final List<String> DEFAULT_JVM_ARGS =
      ImmutableList.of(
          "-Xmx512m", "-Xms256m", "-XX:MaxPermSize=256m", "-XX:+HeapDumpOnOutOfMemoryError");

  // deenu modfify: set default args for android/dalvik
  /**
   * public static final List<String> DEFAULT_JVM_8_ARGS = ImmutableList.of("-Xmx512m", "-Xms256m",
   * "-XX:MaxMetaspaceSize=256m", "-XX:+HeapDumpOnOutOfMemoryError");
   */
  public static final List<String> DEFAULT_JVM_8_ARGS;

  static {
    if (isRunningAndroid() || isDalvik()) {
      DEFAULT_JVM_8_ARGS = ImmutableList.of("-Xmx512m", "-Xms256m");
    } else {
      DEFAULT_JVM_8_ARGS =
          ImmutableList.of(
              "-Xmx512m",
  ...
  public static final List<String> ALLOW_ENVIRONMENT_VARIABLE_OVERWRITE =
      ImmutableList.of("--add-opens", "java.base/java.util=ALL-UNNAMED");
  ...
  public void setEnvironmentVariables(Map<String, String> envVariables) {
    this.envVariables =
        envVariables == null ? new HashMap<String, String>(System.getenv()) : envVariables;
  }
