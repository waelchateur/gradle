...
abstract class CurrentGradleInstallationLocator {
  ...
  private static final String BEACON_CLASS_NAME =
      "org.gradle.internal.installation.beacon.InstallationBeacon";
  ...
  /**
   * Returns the root directory of a distribution based on the code source of a JAR file. The JAR
   * can either sit in the lib or plugins subdirectory. Returns null if distribution doesn't have
   * expected directory layout.
   *
   * <p>The expected directory layout for JARs of a distribution looks as such:
   *
   * <p>dist-root |_ lib |_ plugins
   *
  ...
  private static File determineDistRootDir(File codeSource) {
    ...
    // deenu modfify: parentDir null check
